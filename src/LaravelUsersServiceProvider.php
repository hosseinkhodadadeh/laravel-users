...
class LaravelUsersServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->publishFiles();
        $this->app->make('hosseinkhodadadeh\laravelusers\App\Http\Controllers\UsersManagementController');
        $this->app->singleton(hosseinkhodadadeh\laravelusers\App\Http\Controllers\UsersManagementController\UsersManagementController::class, function () {
